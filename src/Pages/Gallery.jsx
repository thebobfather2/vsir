          ...
          {nfts.map((nft, index) => (
            <Grid item key={index} md={3} lg={2}>
              <div className='AllImages'>
                <img src={metadata?.[nft.mint]?.image} className="nftImages" alt="loading" />
                <br />
                <p className='nftTitles'>{nft.data.name}</p>
                <div className='logoContainer'>
                  <a href={'https://magiceden.io/item-details/' + nft.mint} target='_blank' rel='noreferrer'><img className='logos' src={magicEden} alt='Magic Eden Logo' /></a>
                  <a href={"https://solscan.io/token/" + nft.mint} target='_blank' rel='noreferrer'><img className='logos' src={Solscan} alt='Solscan Logo' /></a>
                </div>
              </div>
            </Grid>
          ))}
